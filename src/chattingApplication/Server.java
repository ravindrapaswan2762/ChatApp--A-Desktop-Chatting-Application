...
public class Server implements ActionListener{
	...
	JTextField text;
	JPanel mp; // main panel for chat screen
	...
	Server(){
		...
		//--------------------- profile 1
		ImageIcon j1 = new ImageIcon(ClassLoader.getSystemResource("icons/p1.png"));
		...
		t.setSize(450, 650);
		t.setLocation(200, 50);// location for opening on window
...
//			p2.add(output);
			...
			dout.writeUTF(out);// for sent msg
	...
	public static JPanel formatLabel(String out) {
		...
		output.setBackground(new Color(37, 140, 90));//37, 140, 90
